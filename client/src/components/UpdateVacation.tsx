...
export default function UpdateVacation(props: any) {

    const [newVacation, setNewVacation] = React.useState({
        description: props.vacation.description,
        img: props.vacation.img,
        location: props.vacation.location,
                ...
                <div className='signup-container'>
                    ...
                    <form action="" className='signup-form'>
                        ...
                        <TextField
                            ...
                            required
                            type={'date'}
                            defaultValue={newVacation.startTime.substring(0, 10)}
                        ...
                        <TextField
                            ...
                            type={'date'}
                            required
                            defaultValue={newVacation.endTime.substring(0, 10)}
                        ...
                        />
                        <Button onClick={(e) => handleUpdate(e)} variant="contained" color="primary">
                            Update
                        </Button>
                    </form>
                </div>
